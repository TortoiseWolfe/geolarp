...
docker compose exec geolarp pnpm test src/utils/consent
docker compose exec geolarp pnpm test src/contexts/Consent
docker compose exec geolarp pnpm test src/components/privacy

# Run integration tests
docker compose exec geolarp pnpm test src/tests/consent
