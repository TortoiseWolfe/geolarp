...
docker compose exec geolarp pnpm run generate:component -- --name ComponentName --category atomic --hasProps true

# Testing (TDD workflow)
docker compose exec geolarp pnpm test                    # Run all tests
docker compose exec geolarp pnpm test:coverage           # Coverage report
docker compose exec geolarp pnpm exec playwright test    # E2E tests
docker compose exec geolarp pnpm run test:a11y:dev       # Accessibility tests

# Code quality
docker compose exec geolarp pnpm run type-check          # TypeScript validation
docker compose exec geolarp pnpm run lint                # ESLint
docker compose exec geolarp pnpm run test:suite          # Full test suite
