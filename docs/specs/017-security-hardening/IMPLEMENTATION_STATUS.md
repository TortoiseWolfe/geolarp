...
- Command: `docker compose exec geolarp pnpm run generate:component -- --name IdleTimeoutModal --category molecular --hasProps true`
...
- Run full test suite: `docker compose exec geolarp pnpm test`
- Run TypeScript check: `docker compose exec geolarp pnpm run type-check`
- Run ESLint: `docker compose exec geolarp pnpm run lint`
...
docker compose exec geolarp pnpm test src/lib/payments/__tests__/metadata-validator.test.ts
...
# Generate component
docker compose exec geolarp pnpm run generate:component -- --name ComponentName --category molecular --hasProps true
```
